class BoostPython157 < Formula
  ...
  def install
    ...
    elsif Tab.for_name("boost157").cxx11?
      odie "boost157 was built in C++11 mode so boost-python157 must be built with --c++11."
    end
  ...
  test do
    ...
    Language::Python.each_python(build) do |python, _|
      ...
      system ENV.cxx, "-shared", "hello.cpp", "-I#{Formula["boost157"].opt_include}",
